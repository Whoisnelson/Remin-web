...
export default function Features () {
    return (
        ...
        <section className="w-screen pt-3 pb-5 features">
            ...
            <p className="text-[0.6em] lg:max-w-[600] md:text-[0.9em] text-gray-800">Every feature in Remin is designed to solve a real challenge creators face-from finding the right people to collaborate with, to capturing ideas before they're forgotten, and staying consistent long enough to grow.</p>
            </div>
